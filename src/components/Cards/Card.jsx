...
export default function Card({image,price,id,true_price,translations,product}) {
            ...
            <div className="card-bottom-info" style={{width:"100%"}}>
                <div className="card-item-name">
                    <Link to={`/product/${id}`} style={{textDecoration:"none"}}>
                       <span style={{maxWidth:"2px"}}>{product.translations[i18n.language].title}</span>
                    </Link>
                </div>
                ...
                <div className="button-container">
                    ...
                    <button className='card-but2'>{t('productDetail.product7')}</button>
                </div>
            </div>
        </div>
    </div>
